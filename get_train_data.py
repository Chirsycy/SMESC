...
# for train_num in  [4,8,12,16,20]:
#     size=15
#     name = "./" + dataset + "_train_"+str(train_num)+".mat"
for dataset in ['indian','houston']:#,'botswana','ksc'
        for size in [5,7,9,11,13,15]:#
            train_num=20
            name = "./" + dataset + "_train_size_" + str(size) + ".mat"
            if dataset=='indian':
            ...
            dict={}
            dict['patches_train']=patches_train
            dict['labels_train']=labels_train
